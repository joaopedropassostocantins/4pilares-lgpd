...
export default function GarantiaPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Durante o período de suporte, você tem acesso direto à nossa equipe especializada em LGPD via e-mail e WhatsApp. Todas as suas dúvidas serão respondidas.",
    },
    {
