...
export default function Home() {
  ...
  return (
    <Layout>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial="hidden" animate="visible" variants={fadeUp}>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Link href="/planos">
                  <Button size="lg" variant="outline" className="px-6 h-12 rounded-xl font-medium border-slate-300 text-slate-700 hover:bg-slate-50">
                    Ver planos e preços
                  </Button>
                </Link>
              </div>
      ...
      {/* ===== MÉTRICAS / TRUST BAND ===== */}
      <section className="py-14" style={{ background: "linear-gradient(135deg, #060B14 0%, #0C1525 100%)" }}>
        <div className="container">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { value: "200+", label: "Empresas atendidas", sub: "em todo o Brasil" },
              { value: "4", label: "Pilares metodológicos", sub: "Lei · Regras · Conformidade · Titular" },
              { value: "R$ 50M", label: "Multa máxima evitada", sub: "LGPD Art. 52" },
              { value: "100%", label: "Remoto e digital", sub: "atendimento nacional" },
            ].map((m, i) => (
              <motion.div
                key={i}
              ...
              >
                <p className="text-3xl lg:text-4xl font-bold text-white mb-1">{m.value}</p>
                <p className="text-sm font-semibold text-blue-300">{m.label}</p>
